...
export async function loadProformaInvoicePrintData(proformaInvoiceId: string): Promise<any | null> {
  ...
  return {
    proformaInvoice: {
      ...
      printPaymentConditions: (invoice as any).printPaymentConditions ?? true,
      printLineImages: (invoice as any).printLineImages || false,
      portOfLoading: (invoice as any).portOfLoading || null,
      portOfDischarge: (invoice as any).portOfDischarge || null,
...
export async function loadPackingListPrintData(packingListId: string): Promise<any | null> {
  ...
  return {
    packingList: {
      ...
      packingDate: packingList.packingDate || packingList.createdAt,
      shipDate: packingList.shipDate || null,
      ...
      purchaseOrder: packingList.purchaseOrder || null,
      totalWeight: packingList.weight || null,
      totalPackages: packingList.totalPackages || null,
