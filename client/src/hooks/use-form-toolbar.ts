...
const ENTITY_CONFIGS: Record<string, EntityConfig> = {
  ...
  "proforma-invoice": {
    apiPath: "/api/proforma-invoices",
    formType: "proforma-invoice",
    label: "Proforma Invoice",
    labelPlural: "Proforma Invoices",
    listQueryKey: "/api/proforma-invoices",
  ...
  "contract-item": {
    apiPath: "/api/contract-items",
    formType: "contract-item",
    label: "Contractregel",
    labelPlural: "Contractregels",
    listQueryKey: "/api/contract-items",
  ...
  "proforma-invoice-line-item": {
    apiPath: "/api/proforma-invoice-items",
    formType: "proforma-invoice-line-item",
    label: "Proforma Line",
    labelPlural: "Proforma Lines",
    listQueryKey: "/api/proforma-invoice-items",
