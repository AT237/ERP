  ...
  const handleEmailExcel = async (customer: Customer) => {
    try {
      ...
      const wsData = [
        ...
        ['', '', '', '', 'CUSTOMER REPORT ' + (customer.customerNumber || ''), '', '', currentDate],
        [''], // Empty row
      ...
      // Generate Excel file
      const fileName = `Customer_Report_${customer.customerNumber}_${new Date().toISOString().split('T')[0]}.xlsx`;
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        {/* Title Section */}
        <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg px-4 py-2 shadow-lg shadow-orange-500/20 ring-1 ring-orange-500/10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-end space-x-4 pt-6 border-t">
              ...
              <Button
                ...
                onClick={() => handleEmailExcel(selectedCustomerForReport!)}
                data-testid="button-email-excel"
              >
